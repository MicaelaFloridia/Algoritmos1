...
public class Main {
    public static void main(String[] args) {
        ...
        hotel.consultarDisponibilidad(LocalDate.of(2024, 06, 14),
                LocalDate.of(2024, 06, 20));

        // Reservar habitaciones
        hotel.reservarHabitacion(juana, LocalDate.of(2024, 06, 14),
                LocalDate.of(2024, 06, 20), 5);
        hotel.reservarHabitacion(pedro, LocalDate.of(2024, 06, 15),
                LocalDate.of(2024, 06, 18), 4);
        ...
        hotel.consultarDisponibilidad(LocalDate.of(2024, 06, 18),
                LocalDate.of(2024, 06, 25));

        // Reservar habitaciones
        hotel.reservarHabitacion(maria, LocalDate.of(2024, 06, 19),
                LocalDate.of(2024, 06, 30), 4);

        // Consultar disponibilidad en el hotel entre el 10 y 25 de junio de 2024
        hotel.consultarDisponibilidad(LocalDate.of(2024, 06, 10),
                LocalDate.of(2024, 06, 25));
